...
export const OPENROUTER_REQUEST_TIMEOUT_MS =
  Number.isFinite(_reqTimeout) && _reqTimeout > 0 ? _reqTimeout : 60_000;
...
export const OPENROUTER_FAILOVER_TOTAL_TIMEOUT_MS =
  Number.isFinite(_failoverTotal) && _failoverTotal > 0 ? _failoverTotal : 70_000;
...
export function saturationRetryDelayMs(attempt) {
