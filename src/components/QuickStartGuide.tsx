...
export default function QuickStartGuide({
  ...
  return (
    <div className={`w-full max-w-sm space-y-2.5 sm:space-y-4 ${className}`.trim()}>
      ...
      <p className="text-[11px] text-soul-500 text-center leading-relaxed max-md:line-clamp-2">
